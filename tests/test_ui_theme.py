...
class UIThemeTests(unittest.TestCase):
    ...
    def test_chart_advanced_controls_are_large_chart_only(self) -> None:
        ...
        self.assertNotIn("function drawTourAnchoredCallout", tour_js)
        self.assertNotIn("function chooseTourCalloutPlacement", tour_js)
        self.assertNotIn("function nearestRectPoint", tour_js)
        self.assertNotIn("function drawTourVisualGlyph", tour_js)
        ...
        self.assertNotIn("function ensureTourCalloutElements", tour_js)
        self.assertIn("function scoreCalloutGeometry", tour_js)
        self.assertIn("function scoreDomCalloutPlacement", tour_js)
        self.assertIn("function collectCandleRects", tour_js)
        self.assertIn("function collectSupportLineYs", tour_js)
        ...
        self.assertNotIn('id="chartTourTitle"', html)
        self.assertNotIn('id="chartTourHeadline"', html)
        self.assertNotIn(".chart-tour-readout h4", css)
        self.assertNotIn(".chart-tour-readout > p", css)
        self.assertNotIn(".chart-tour-readout .chart-tour-details { display: none; }", css)
