...
class UIThemeTests(unittest.TestCase):
    ...
    def test_chart_advanced_controls_are_large_chart_only(self) -> None:
        ...
        self.assertIn('id="forecastLabBtn"', html)
        self.assertIn('id="forecastLabPanel"', html)
        self.assertIn('id="forecastLabOverlay"', html)
        self.assertIn("大型K線圖", html)
        self.assertIn("讀圖導覽", html)
        self.assertIn("盤中暫算", html)
        self.assertIn("技術面推估", html)
        self.assertIn("實驗·非建議", html)
        ...
        self.assertIn(".forecast-lab-panel", css)
        self.assertIn(".chart-panel.chart-lab-mode.chart-forecast-mode", css)
        self.assertIn(".forecast-lab-modal", css)
        ...
        self.assertIn("forecastLabEnabled", js)
        self.assertIn("chartUxMode", js)
        self.assertIn("function toggleLargeChart", js)
        self.assertIn("function toggleForecastLab", js)
        self.assertIn("function renderForecastLabPanel", js)
        self.assertIn("function buildForecastLabScenarioFan", js)
        self.assertIn("function drawForecastLabOverlay", js)
        self.assertIn("/forecast-lab?days=365", js)
        ...
        self.assertIn("推估範圍", js)
        self.assertIn("實驗參考", js)
    ...
    def test_local_data_table_exposes_gap_status(self) -> None:
        ...
        self.assertIn("先用全市場資料快速補到最近收盤", html)
        self.assertIn("個股歷史不足", html)
