...
| S2 | 盤點頁 O(N) 重算 SR/coverage | P2(速度) | 待修：寫入時預算 |
...
| SR-2 | 末端 3 根偵測不到最新轉折 | P1/P2 | 待修：文案或末端縮小 k |
| SR-3 | 單一插針即設關卡（無聚類/多次測試） | P2 | 待修：聚類或門檻 |
| SR-4 | 趨勢/突破仍顯示「區間中」 | P2 | 部分修：突破/破底已有狀態；一般趨勢待設計 |
