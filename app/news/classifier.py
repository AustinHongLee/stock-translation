...
FORBIDDEN_PHRASES: tuple[str, ...] = (
    _phrase("建議", "買"), _phrase("建議", "賣"), _phrase("該", "買"), _phrase("該", "賣"),
    _phrase("買", "進"), _phrase("賣", "出"), "加碼", "減碼操作",
    _phrase("目標", "價"), _phrase("會", "漲"), _phrase("會", "跌"), _phrase("將", "漲"), _phrase("將", "跌"),
    "抄底", "逢低", "放空", "進場", "出場",
    _phrase("便宜", "價"), _phrase("合理", "價"), _phrase("昂貴", "價"), _phrase("低", "估"), _phrase("高", "估"),
)
...
EVENT_KEYWORDS: dict[str, tuple[str, ...]] = {
    ...
    "財報內控": (
        "財報延遲", "延後公告財報", "未如期公告財報", "未如期申報財報", "財報遲交",
        "內控缺失", "內部控制缺失", "內控異常", "重編財報", "更正財報",
    ),
    "資產處分": (
    ...
    "營運異常": (
        "停工", "停產", "關廠", "裁員", "資遣", "無薪假", "召回", "工安意外", "火災", "爆炸",
        "取消訂單", "客戶延後拉貨", "交期遞延", "出貨遞延",
    ),
    "資安事件": ("資安", "資安事件", "資安攻擊", "勒索軟體", "駭客攻擊", "資料外洩", "個資外洩", "系統遭入侵"),
    "政策法規": ("政策", "法規", "補助", "關稅", "制裁", "禁令", "許可", "環評", "主管機關", "證交所", "櫃買中心"),
    "供需價格": (
        "報價", "漲價", "降價", "殺價", "價格戰", "供過於求", "供不應求", "庫存", "缺貨",
        "庫存去化", "存貨跌價", "產能利用率",
    ),
}
